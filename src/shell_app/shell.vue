    ...
    methods: {
      load_instance(instance_config_id) {
        const instance_config = {
          ...
          'snackbar': {'message': 'Current API key is not valid. Please log out and try to login again.'},
          'sw_message': {'message': null, 'title': null},
          'sw_update_downloading': false,
          'sw_update_available': false,
          'network_online': true,
          'trigger_help_visible_irrelevant_value': false,
          'irs_monitor': {
            'ui': {'show_filters': true},
            'last_id': null,
            'filter': null,
            'map_options': {'show_response_points': true, 'selected_layer': 'normalised_risk'},
            'responses_last_updated_at': null,
            'dashboard_options': {
              'temporal_aggregation_level': 'week',
              'spatial_aggregation_level': 'villages',
              'limit_to_plan': true,
              'limit_to': '',
              'season_start_date': '2017-05-19',
              'bin_by': 'location.selection.id'
            },
            'filters': [],
            'guess_selection_ids': {},
          ...
          'irs_plan': {
            ...
            'show_lowest_spatial_level': true,
            'plan_list': [],
          ...
          'meta': {
            'user': {
              ...
              'name': 'Jonathan',
              'username': 'js',
              'key': '0e1b2cbde6d9954bc7fd329459c28c0b',
              'instance_slug': 'all',
              ...
              'app_commit_hash': 'v1.2.13-43-g06c3070'
            }, 'previous_route': '/meta/home', 'personalised_instance_id': 'zexubugi-820', 'configurations': []
          },
          'loading': {'activeLoaders': []}
        }
        console.log('load sample instance_config', instance_config)
      }
    }
  }
</script>
