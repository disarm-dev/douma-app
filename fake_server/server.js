...
server.get('/instances/:instance_id/published_instance_config', (req, res) => {
  const fake_instance_config = {
    '_id': 'bwa@1.0.21',
    'config_id': 'bwa',
    ...
    'applets': {
      'irs_monitor': {
        ...
        'season_start_dates': ['2018-01-01', '2017-05-19'],
        'table': {
    ...
    'form': {
      'pages': [{
        ...
        'elements': [{
          ...
          'isRequired': true,
          'validators': [{'type': 'numeric', 'text': 'Minimum value must be zero', 'minValue': 0}],
          'inputType': 'number'
        }, {
          'type': 'text',
        ...
        'elements': [{
          ...
          'isRequired': true,
          'validators': [{'type': 'numeric', 'text': 'Minimum value is 0', 'minValue': 0}],
          'inputType': 'number'
        }, {
          'type': 'text',
  ...
  res.jsonp({instance_config: fake_instance_config})
})

server.get('/users/:user_id/permissions/:instance_id', (req, res) => {
